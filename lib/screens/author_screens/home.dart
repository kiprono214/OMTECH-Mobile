...
import 'package:OMTECH/screens/author_screens/create_tag.dart';
import 'package:OMTECH/screens/author_screens/tag_details.dart';
...
class _MyWidgetState extends State<MyWidget> {
  void toAction() {
    Navigator.of(context)
        .pushReplacement(MaterialPageRoute(builder: (context) => ActionM()));
  }
