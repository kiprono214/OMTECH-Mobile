...
import 'package:OMTECH/screens/dashScreens/asset_work_orders.dart';
import 'package:OMTECH/screens/dashScreens/client_home.dart';
import 'package:OMTECH/screens/dashScreens/create_asset.dart';
...
class AssetDetailBackPress extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return GestureDetector(
        onTap: () {
          // Navigator.of(context).push(MaterialPageRoute(builder: (context) => AssetsStream(title: title)));
        },
        child: Container(
            width: 60,
...
class _AssetDetailsState extends State<AssetDetails> {
  ...
  Future<void> getImg() async {
    ...
    final ref = await FirebaseStorage.instance.ref().child('asset_images/$use');
                            ...
                            GestureDetector(
                                onTap: () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) =>
                                          AssetsStream(title: widget.project)));
                                },
                                child: Container(
                                    width: 60,
                                    alignment: Alignment.bottomLeft,
