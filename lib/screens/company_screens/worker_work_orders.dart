...
class WorkerWork extends StatefulWidget {
  WorkerWork({Key? key, required this.worker}) : super(key: key);

  String worker;

  @override
  State<WorkerWork> createState() => _WorkerWorkState();
}

class _WorkerWorkState extends State<WorkerWork> {
  ...
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
        ...
        .where('worker', isEqualTo: widget.worker)
